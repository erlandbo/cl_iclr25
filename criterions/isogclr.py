...
# https://github.com/zhqiu/contrastive-learning-iSogCLR/blob/main/unimodal_exps/losses.py
...
class SogCLR_Loss(nn.Module):
    def __init__(self, N=15000000, gamma=0.9, temperature=0.1):
...
class SogCLR_DRO_Loss(nn.Module):
    def __init__(self, N=15000000, gamma=0.8, tau_init=0.7, tau_min=0.05, tau_max=1.0, rho=0.4, bsz=256,
